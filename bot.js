...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['BlackSide','BlackSide Server'];
    var i = -1;
    var j = 0;
...
var args = message.content.split(" ").slice(1);
    ...
    //end of create role
    let mutetime = args[1];
    if(!اسكتت) return message.reply("**يرجى تحديد وقت الميوت**:x:");
...
if(bz.content.startsWith(prefix + 'عمل')) {
...
const embed = new Discord.RichEmbed()
     ...
     .setFooter('Requested by '+message.author.username, message.author.avatarURL)
   .setDescription(`**لون Changed To Successfully** :white_check_mark: `)
